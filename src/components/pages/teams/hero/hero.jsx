        ...
        <div className="md:scrollbar-hidden mx-auto mt-20 max-w-[1220px] bg-black md:max-w-none md:overflow-x-auto">
          <div className="mt-5 md:min-w-[1080px] md:px-7 sm:px-4">
            ...
            {team.users.map((user, index) => (
              <ul>
                <li className="grid grid-cols-[175px_420px_175px_175px_1fr] gap-x-5 border-b border-gray-2 py-4 lg:grid-cols-[130px_390px_1fr_1fr_1fr] md:grid-cols-[130px_485px_230px_1fr_1fr] sm:grid-cols-[150px_80px_120px]">
        ...
        <div className="md:scrollbar-hidden mx-auto mt-20 max-w-[1220px] bg-black md:max-w-none md:overflow-x-auto">
          <div className="mt-5 md:min-w-[1080px] md:px-7 sm:px-4">
            ...
            {JSON.parse(team.prs || '[]').map((pr, index) => (
              <ul>
                <li className="grid grid-cols-[230px_485px_230px_1fr] gap-x-5 border-b border-gray-2 py-4 lg:grid-cols-[130px_390px_1fr_1fr] md:grid-cols-[130px_485px_230px_1fr] sm:grid-cols-[170px_50px_100px]">
                  <span className="sm:hidden">{index + 1}</span>
                  <p className="truncate font-medium">
                    {pr.status === 'DELETED' && (
                      <span className="font-bold" style={{ color: 'red' }}>
